...
?>
    ...
    <div id="content">
        <div id="bg" class=" ">
            ...
            <p>Giảm giá cố định 40% đối với các thương hiệu cao cấp</p>
            <a href="products.php" class="btn btn-warning btn-lg text-white">Mua ngay</a>
    ...
    <div class="text-center pt-4 h3">
        * Hãy là những người đàn ông thời trang *
    </div>
