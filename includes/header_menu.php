                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#watch" class="dropdown-item">Đồng hồ</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content"style="background-color:rgba(255,255,255,0.95)">
            ...
            <div class="modal-body">
              <form action="login_script.php" method="post">
                ...
                <div class="form-check">
                    ...
                    <label for="checkbox" class="form-check-label">Lưu thông tin</label>
                </div>
            ...
            <div class="modal-footer">
              <p class="mr-auto">Chưa có tài khoản? <a href="#signup" data-toggle="modal" data-dismiss="modal" >Đăng ký</a></p>
            ...
            <div class="modal-body">
              <form action="signup_script.php" method="post">
                ...
                <div class="form-check">
                    ...
                    <label for="checkbox" class="form-check-label">Đồng ý các điều khoản và điều kiện</label>
                </div>
                <button type="submit" class="btn btn-primary btn-block" name="Submit">Đăng ký</button>
              </form>
            </div>
            <div class="modal-footer">
              <p class="mr-auto">Đã đăng ký?<a href="#login"  data-toggle="modal" data-dismiss="modal">Đăng nhập</a></p>
              <button type="button" class="btn btn-secondary" data-dismiss="modal" >Đ</button>
            </div>
          </div>
        </div>
      </div>
